...
{
    volatile uint32_t A[1024] __attribute__ ((aligned (64)));
    volatile uint32_t W[16384] __attribute__ ((aligned (64)));
    volatile uint32_t R[1024] __attribute__ ((aligned (64)));
    cbo_flush_all();
