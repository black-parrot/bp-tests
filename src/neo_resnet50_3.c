...
volatile uint32_t A[16] __attribute__ ((aligned (64))) = {0};
volatile uint32_t W[16] __attribute__ ((aligned (64))) = {0};
volatile uint32_t R[16] __attribute__ ((aligned (64))) = {0};
